...
int redLEDPin = 9; // Red LED, connected to digital PWMpin 9
...
void loop()
{
    ...
    distance = pulseTime / 58;            // Distance = pulse time / 58 to convert tocm.
    ...
    {
        redLEDValue = 255 - averageDistance; // this means the smaller the distance the brighter the LED.
    }
